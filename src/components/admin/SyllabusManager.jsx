...
const SyllabusManager = () => {
    ...
    return (
        <div className="space-y-6 w-full animate-in fade-in duration-300">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-gray-50/95 backdrop-blur-sm py-4 lg:sticky lg:top-[64px] z-20 border-b border-gray-200">
                <div>
