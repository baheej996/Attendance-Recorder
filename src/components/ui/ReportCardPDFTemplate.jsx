    ...
    return (
        ...
        >
            <div className="relative h-full w-full bg-white p-12 flex flex-col pt-8">
                ...
                {/* 2. Student Info Box */}
                <div className="bg-[#f8f9fc] rounded-xl p-8 mb-8 flex flex-row items-center justify-between border-0">
                    <div>
                ...
                <div className="relative border border-[#e2e8f0] rounded-xl overflow-hidden flex-grow mb-16">
                    {/* Watermark Logo */}
                    ...
                    <table className="w-full relative z-10">
                        <thead>
                            <tr className="border-b border-[#e2e8f0]">
                                <th className="text-left py-4 px-6 text-xs font-bold text-[#64748b] tracking-wider uppercase">Subject</th>
                                <th className="text-center py-4 px-6 text-xs font-bold text-[#64748b] tracking-wider uppercase">Marks</th>
                                <th className="text-right py-4 px-6 text-xs font-bold text-[#64748b] tracking-wider uppercase">Status</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-[#e2e8f0]">
                            {stats.subjectBreakdown.map((sub, idx) => (
                                <tr key={sub.id || idx}>
                                    <td className="py-4 px-6 text-sm font-bold text-[#334155]">{sub.name}</td>
                                    <td className="py-4 px-6 text-sm font-medium text-[#64748b] text-center">
